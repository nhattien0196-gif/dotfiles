...
hl.bind(mainMod .. " + CTRL + L", hl.dsp.exec_cmd("qs ipc call power toggle"), { description = "Power menu" })
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-power -l"), {
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("flameshot gui"), { description = "Flameshot Screenshot" }
)
